package in.bhimashankar.airdrive.security;
...
public class ClerkJwksProvider {
    ...
    public PublicKey getPublicKey(String kid) throws Exception { // kid - keyId
    ...
    private void refreshKey() throws Exception {
        ...
        for (JsonNode keyNode : keys) {
            String kid = keyNode.get("kid").asText(); // keyId
            String kty = keyNode.get("kty").asText(); // keyType
            String alg = keyNode.get("alg").asText(); // algorithm
